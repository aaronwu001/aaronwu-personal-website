> **TL;DR:** 這是我在經歷十幾場面試、拿下 AMD 機會並與多位大廠主管深聊後，領悟到的面試反直覺真相——在這個履歷過度包裝的時代，資深面試官早就對空泛的「商業影響力」免疫。真正能讓你脫穎而出的，是「有底氣的誠實」與「刨根問底的技術好奇心」。
...
「可是，有的專案真的需要數字來表現它有多成功啊？這證明了我的能力和努力。」
「我問你，一個準確率，從 80% 提升到 95%，這數字有什麼意義？」
「可以為公司和團隊帶來價值。」
「那它有以任何程度說明這背後的團隊中的開發者嗎？他們是成功的？」
「對，除此之外什麼資訊量都沒有。我不管你的專案在 production 賺了多少錢、解決了多少人的問題，或是讓速度或準確率快了多少，因為這些成功背後，都可以有一個有問題的工程師只是剛好調整了某個 API，或是用錯誤的解決問題方式去達到目標，有些取捨被隱藏了。相反的，很多徹底失敗的專案背後，也可以有真的很優秀的工程師，只是真的有太多無法列入考慮的因素可以影響結果了。所以說對於一個邏輯清晰的 hiring manager 來說，metrics doesn't really mean anything to this very candidate。」
...
我深吸一口氣，決定放棄所有包裝，誠實講述我當初純粹「因為好奇」而私下做的底層測試。結果，我反而靠著這些死去的記憶和他的測試打得有來有回。雖然我後來沒上（我覺得很合理，因為我對於 agent 測試準備的實在不夠充足），不過這讓我學會重要的一課：在面試時作為我底氣的，除了清楚自己知道什麼、我不知道什麼、為什麼要怎麼做以外，還需要刨根問底的技術好奇心，因為他們在找的不是一個會考試的機器，而是一個**遇到 Bug 會想去挖底層邏輯的活人**。
